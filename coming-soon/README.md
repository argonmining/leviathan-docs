...
* Testnet-only scope — no mainnet promises in this doc
* Experimental bridge — exercise carefully
* Mobile store builds remain outside public pioneer documentation
